...
class TgParseAdStatsByCabinet implements ShouldQueue
{
    ...
    public bool $fullParse = true;

    /**
     * Create a new job instance.
     */
    public function __construct(Cabinet $cabinet, $fullParse = false)
    {
...
//        $ads = $this->cabinet->ads()->whereIn("status_id", AdStatus::WORK_STATUSES)->get();
//
//        foreach ($ads as $ad)
//        {
//            try {
